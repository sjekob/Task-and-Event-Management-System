                ...
                if (showMenu)
                  PopupMenuButton<String>(
                    ...
                    itemBuilder: (_) => [
                      ...
                      PopupMenuItem(value: 'delete', child: Row(children: [const Icon(Icons.delete_outline, size: 16, color: AppTheme.redColor), const SizedBox(width: 8), Text('Delete', style: AppTheme.labelMd.copyWith(color: AppTheme.redColor))])),
                    ],
                  ),
              ],
            ),
