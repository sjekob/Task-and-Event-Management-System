        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              // Stat cards
              const Row(children: [
                Expanded(child: _CoordinatorStatCard(label: 'Pending Review', value: '1', valueColor: Color(0xFFF59E0B), icon: Icons.calendar_today_outlined, iconColor: Color(0xFFF59E0B))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'Evaluated', value: '2', valueColor: Color(0xFF10B981), icon: Icons.star_border_outlined, iconColor: Color(0xFF10B981))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'Flagged Alerts', value: '1', valueColor: Color(0xFFEF4444), icon: Icons.error_outline, iconColor: Color(0xFFEF4444))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'Avg Rating', value: '3.5/5', valueColor: Color(0xFF475569), icon: Icons.star_border_outlined, iconColor: Color(0xFF94A3B8))),
              ]),
              const SizedBox(height: 18),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          width: 36, height: 36,
          decoration: const BoxDecoration(color: AppColors.tabActive, shape: BoxShape.circle),
