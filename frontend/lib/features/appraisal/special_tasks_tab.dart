        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              // Stat cards
              const Row(children: [
                Expanded(child: _CoordinatorStatCard(label: 'Total Faculty Evaluated', value: '4', valueColor: Color(0xFF10B981), icon: Icons.check_circle_outline, iconColor: Color(0xFF10B981))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'Flagged Personnel', value: '1', valueColor: Color(0xFFEF4444), icon: Icons.error_outline, iconColor: Color(0xFFEF4444))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'Departments Monitored', value: '4', valueColor: Color(0xFF8B5CF6), icon: Icons.group_outlined, iconColor: Color(0xFF8B5CF6))),
                SizedBox(width: 14),
                Expanded(child: _CoordinatorStatCard(label: 'School Avg Compliance / 100', value: '273', valueColor: Color(0xFF475569), icon: Icons.emoji_events_outlined, iconColor: Color(0xFF94A3B8))),
              ]),
              const SizedBox(height: 18),
