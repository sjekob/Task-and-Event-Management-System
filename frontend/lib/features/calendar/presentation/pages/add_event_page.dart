...
class _AddEventPageState extends State<AddEventPage> {
  ...
  final _p2Ctrl = TextEditingController(
      text: 'Training-workshop sessions');
  final _p3Ctrl = TextEditingController(
      text: 'Selection of school paper staff\nEvaluation of the activity');
  ...
  void initState() {
    ...
    _twgGroups  = [
      {
        'title': TextEditingController(text: 'Supervising Committee'),
        'members': <Map<String, TextEditingController>>[_newMember()],
      },
      {
        'title': TextEditingController(text: 'Program Implementation Committee'),
        'members': <Map<String, TextEditingController>>[_newMember()],
      },
    ];
  }
  ...
  void dispose() {
    ...
    _venueCtrl.dispose(); _budgetCtrl.dispose();
    _fundCtrl.dispose(); _focalNameCtrl.dispose();
    _focalRoleCtrl.dispose(); _focalCpCtrl.dispose();
    _rationaleCtrl.dispose();
    _p1Ctrl.dispose(); _p2Ctrl.dispose(); _p3Ctrl.dispose();
  ...
  Future<void> _submitProposal() async {
    ...
    final twgData = _twgGroups.map((g) => {
      ...
      'members': (g['members']
          ...
          .map((m) => {
                'name':        m['name']!.text,
                'designation': m['designation']!.text,
                'tor':         m['tor']!.text,
    ...
    final payload = {
      ...
      'expected_outputs': jsonEncode(
          _outputCtrls.map((c) => c.text).toList()),
    ...
    if (result != null && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Failed to submit. Is the server running?'),
...
return Scaffold(
              ...
              child: Row(
                ...
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    border: Border(
                        top: BorderSide(color: Color(0xFFACC2DF))),
                  ),
                  child: Row(
          ...
          children: [
            ...
            Row(children: [
              Expanded(child: Column(
                ...
                children: [
                  ...
                  _tField(_dateCtrl,
                      hint: 'e.g. October 23, 24 & 28, 2024'),
                ],
              )),
            ...
            Container(
              ...
              child: Table(
                ...
                children: [
                  TableRow(
                    decoration:
                        const BoxDecoration(color: Color(0xFFF7F9FC)),
                  ...
                  _paxRow('Teachers/Speakers', _tMale,
                      _tFemale, 'tm', 'tf'),
                  _paxRow('Aspiring journalists', _jMale,
                      _jFemale, 'jm', 'jf'),
                  TableRow(children: [
                    const Padding(
                    ...
                    ...[
                      _tMale + _jMale,
                      _tFemale + _jFemale,
                      _tMale + _tFemale + _jMale + _jFemale,
                    ].map((v) => Padding(
                        padding: const EdgeInsets.all(10),
                        child: Text('$v',
                            textAlign: TextAlign.center,
            ...
            ..._outputCtrls.asMap().entries.map((e) => Padding(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: _tField(e.value,
                            hint: 'Expected output...')),
                  ]),
                )),
            TextButton.icon(
                onPressed: () => setState(() =>
                    _outputCtrls.add(TextEditingController())),
            ...
            Row(children: [
              ...
              Expanded(child: Column(
                ...
                children: [
                  ...
                  _tField(_fundCtrl,
                      hint: 'e.g. School Paper Fund/SPTA Fund'),
                ],
              )),
            ]),
            const SizedBox(height: 16),
            ...
            Row(children: [
              Expanded(
                  child: _tField(_focalNameCtrl, hint: 'Full name')),
              const SizedBox(width: 12),
              Expanded(
                  child: _tField(_focalRoleCtrl,
                      hint: 'Designation')),
              const SizedBox(width: 12),
              Expanded(
                  child: _tField(_focalCpCtrl,
                      hint: 'CP # / Contact')),
            ]),
          ],
        ),
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _tField(_rationaleCtrl,
                hint: 'Provide the rationale for this activity...',
                maxLines: 8),
                ...
                child: Container(
                  ...
                  child: Table(
                    ...
                    children: [
                      ...
                      _phaseRow('Phase 1',
                          'Pre-Implementation Stage', _p1Ctrl),
                      _phaseRow('Phase 2', 'Implementation', _p2Ctrl),
                      _phaseRow('Phase 3',
                          'Post-Implementation', _p3Ctrl),
                    ],
                  ),
                ),
              ),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(children: [
                ...
                ..._matrixRows.asMap().entries.map((e) =>
                    Column(children: [
                      Padding(
                        ...
                        child: Row(children: [
                          Expanded(
                              flex: 2,
                              child: _mini(e.value['day']!,
                                  'Oct. 23, 2024')),
                          const SizedBox(width: 8),
                          Expanded(
                              flex: 2,
                              child: _mini(e.value['time']!,
                                  '4:00-5:00 PM')),
                          const SizedBox(width: 8),
                          Expanded(
                              flex: 3,
                              child: _mini(e.value['event']!,
                                  'e.g. News Writing')),
                          const SizedBox(width: 8),
                          Expanded(
                              flex: 3,
                              child: _mini(e.value['speaker']!,
                                  'Speaker name')),
                          const SizedBox(width: 8),
                          GestureDetector(
                            onTap: () => setState(() =>
                                _matrixRows.removeAt(e.key)),
                            child: const Icon(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _budgetTable(
              headers: [
                'Particulars', 'No. of Participants',
                'Cost/pax', 'Total'
              ],
              rows: _snackRows,
              keys: ['item', 'pax', 'cost', 'total'],
              hints: ['Meals', '11 pax', '100.00', '1100.00'],
              onAdd: () =>
                  setState(() => _snackRows.add(_newSnack())),
              onRemove: (i) =>
                  setState(() => _snackRows.removeAt(i)),
            ),
            const SizedBox(height: 28),
            ...
            _committeeTable(
              ...
              keys: ['name', 'position'],
              hints: [
                'e.g. FREDERICK M. BALDOZA', 'e.g. Principal'
              ],
              onAdd: () =>
                  setState(() => _execRows.add(_newExec())),
              onRemove: (i) =>
                  setState(() => _execRows.removeAt(i)),
            ),
              ...
              return Column(
                ...
                children: [
                  ...
                  _committeeTable(
                    ...
                    headers: [
                      'Name', 'Designation',
                      'Terms of Reference', 'Output'
                    ],
                    keys: [
                      'name', 'designation', 'tor', 'output'
                    ],
                    hints: [
                      'Full name', 'e.g. Chairperson',
                      'e.g. Leads the Committee',
                      'e.g. Checked reports'
                    ],
                    onAdd: () =>
                        setState(() => members.add(_newMember())),
                    onRemove: (i) =>
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _tField(_meCtrl,
                hint: 'Add specific monitoring instructions or evaluation criteria...',
                maxLines: 6),
            const SizedBox(height: 28),
            ...
            Container(
              ...
              child: Column(children: [
                ...
                const Divider(
                    height: 1, color: Color(0xFFE2E8F0)),
                ..._indicators.asMap().entries.map((e) =>
                    Column(children: [
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            horizontal: 12, vertical: 10),
            ...
            _tField(_commentsCtrl,
                hint: 'Write your comments and recommendations here...',
                maxLines: 5),
          ],
        ),
      ),
  ...
  // ── Shared helpers ─────────────────────────────────────────
  TableRow _paxRow(String label, int male, int female,
      String mk, String fk) {
  ...
  TableRow _phaseRow(String ph, String stage,
...
Widget _tField(TextEditingController c,
  ...
  return TextField(
    ...
    decoration: InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(8),
          borderSide: const BorderSide(
              color: Color(0xFFACC2DF), width: 1.5)),
      contentPadding: const EdgeInsets.symmetric(
