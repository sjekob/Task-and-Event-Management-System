      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const Row(children: [
          Expanded(child: _CoverageCard(
              icon: Icons.description_outlined, iconColor: Color(0xFF3B82F6),
              iconBg: Color(0xFFEFF6FF),
              title: 'Special Task Timing', subtitle: 'Task completion and timeline')),
          SizedBox(width: 12),
          Expanded(child: _CoverageCard(
              icon: Icons.calendar_month_outlined, iconColor: Color(0xFF10B981),
              iconBg: Color(0xFFECFDF5),
              title: 'Event Evaluation', subtitle: 'Multi-stakeholder')),
          SizedBox(width: 12),
          Expanded(child: _CoverageCard(
              icon: Icons.assignment_outlined, iconColor: Color(0xFF8B5CF6),
              iconBg: Color(0xFFEDE9FE),
              title: 'Special Task Ratings', subtitle: 'Weighted rubric')),
          SizedBox(width: 12),
          Expanded(child: _CoverageCard(
              icon: Icons.error_outline, iconColor: Color(0xFFEF4444),
      ...
      child: Row(children: [
        ...
        Expanded(flex: 3, child: Row(children: [
          const CircleAvatar(radius: 14, backgroundColor: Color(0xFFE2E8F0),
              child: Icon(Icons.person_outline, size: 14, color: AppTheme.textMuted)),
          const SizedBox(width: 8),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const Row(children: [
          Expanded(child: _RubricCard(icon: Icons.calendar_month_outlined,
              iconColor: Color(0xFF10B981), label: 'Organization', pct: '20%')),
          SizedBox(width: 12),
          Expanded(child: _RubricCard(icon: Icons.group_outlined,
              iconColor: Color(0xFFF59E0B), label: 'Engagement', pct: '25%')),
          SizedBox(width: 12),
          Expanded(child: _RubricCard(icon: Icons.check_circle_outline,
              iconColor: Color(0xFF8B5CF6), label: 'Content Quality', pct: '30%')),
          SizedBox(width: 12),
          Expanded(child: _RubricCard(icon: Icons.access_time_outlined,
              iconColor: Color(0xFFEC4899), label: 'Time Management', pct: '15%')),
          SizedBox(width: 12),
          Expanded(child: _RubricCard(icon: Icons.sentiment_satisfied_outlined,
              iconColor: Color(0xFF9CA3AF), label: 'Overall Experience', pct: '10%')),
        ]),
        const SizedBox(height: 12),
        Container(height: 36,
            decoration: BoxDecoration(
